...
- Indsat `<div class="scene">`, hvor jeg har sat et baggrundsbillede ind og billeder som fungerer som knapper

## style.css

- Stylet `<p>Tryk på en fisk!</p>` så den er mere fængende i designet og tilføjet `@keyframes scale` så den kan få en animation
- Fjernet baggrundsbilledet og i stedet tilføjet i html, da det på denne måde kan opføre sig som et normalt responsivt billede uden at blive beskåret af CSS
